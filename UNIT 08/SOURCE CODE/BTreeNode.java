...
public void traverse()
{
	...
	// last pointer at C[n] that has no corresp key on its right
	if (leaf == false)
		C[i].traverse();
}
    ...
    public void setKeys(int key, int indexPos) {
        this.keys[indexPos] = key;
    }
    ...
    public void setC(BTreeNode C, int indexPos) {
        this.C[indexPos] = C;
    }
